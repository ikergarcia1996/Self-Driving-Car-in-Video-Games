...
torchrun --standalone --master_port 37227 --nproc_per_node=1 train_TEDD1104.py configs/video-classification/TEDD1104-base_ps30_ts5_bs256.yaml
torchrun --standalone --master_port 37227 --nproc_per_node=1 train_TEDD1104.py configs/video-classification/eval/TEDD1104-base_ps30_ts5_bs256.yaml
