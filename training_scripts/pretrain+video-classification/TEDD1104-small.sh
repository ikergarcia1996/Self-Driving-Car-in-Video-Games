#!/bin/bash
#SBATCH --job-name=pretrain+video-classification-small
#SBATCH --cpus-per-task=128
#SBATCH --gres=gpu:4
#SBATCH --mem=480G
#SBATCH --output=.slurm/pretrain+video-classification-small.out.txt
#SBATCH --error=.slurm/pretrain+video-classification-small.err.txt
